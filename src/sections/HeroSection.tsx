...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] overflow-hidden bg-gradient-to-br from-[#001C7D] via-[#00239C] to-slate-950 text-white">
      <div className="absolute inset-0 opacity-10" style={{
        backgroundImage: "radial-gradient(circle at 2px 2px, white 1px, transparent 0)",
        backgroundSize: "40px 40px",
      }} />
      <div className="absolute left-10 top-20 h-72 w-72 rounded-full bg-blue-500/20 blur-3xl" />
      <div className="absolute right-10 bottom-16 h-80 w-80 rounded-full bg-blue-400/15 blur-3xl" />
      ...
      <div className="container-page relative z-10 py-24 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          ...
          <a className="btn btn-outline-white" href={siteContent.hero.ctas[1].href}>
